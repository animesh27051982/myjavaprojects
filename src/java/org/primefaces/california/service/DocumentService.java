...
public class DocumentService {
    ...
    public TreeNode createDocuments() {
		...
		TreeNode ru1015 = new DefaultTreeNode(new Document("RU1015 FPD ENG'D MOOSIC PARTS DISTR", "-", "Folder", "AMSS", "20", "10", "5"), root);
		TreeNode ru1100 = new DefaultTreeNode(new Document("RU1100 FPD ENG'D TANEYTOWN MD", "-", "Folder", "IPO", "30", "20", "5"), root);
		TreeNode ru1200 = new DefaultTreeNode(new Document("RU1200 FPD ENG'D CPO VERNON", "-", "Folder", "EPO", "20", "10", "5"), root);
		
		TreeNode chevron = new DefaultTreeNode(new Document("Chevron Products - 1072381", "-", "Pages Document", "AMSS", "15", "0", "0"), ru1015);
		TreeNode phillips = new DefaultTreeNode(new Document("Phillips 66 - 07771205", "-", "Pages Document", "AMSS", "5", "0", "0"), ru1015);
