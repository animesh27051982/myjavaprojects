<%@page import="com.flowserve.system606.service.AdminService"%>
    ...
    <body>
        <div class="container">
            ...
            <%
                ...
                System.out.println(auth.getLastResponseXML());
                Logger.getLogger("samlConsumer").log(Level.INFO, "responseXML: " + auth.getLastResponseXML());
                ...
                if (!errors.isEmpty()) {
                    ...
                    if (subject == null) {
                        subject = new Subject();
                        subject.getPrincipals().add(adminService.findUserByFlsIdType(nameId));
                    }

                    String relayState = request.getParameter("RelayState");

                    if (relayState != null && relayState != ServletUtils.getSelfRoutedURLNoQuery(request)
                            && !relayState.contains("/loginSaml.xhtml")) { // We don't want to be redirected to login.jsp neither
